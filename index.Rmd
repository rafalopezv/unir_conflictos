...
<br>
```{r, include=T, echo = F, fig.width = 17, fig.height = 17}
mapa_donde
```
<br>
<br>
...
Coloque el cursor sobre los segmentos de las barras para ver el nivel de radicalidad según demandante.
